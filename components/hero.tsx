      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4 text-black-800" data-aos="fade-up">Rencontrez des sportifs d’exception avec The Sport Network</h1>
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              ...
              {/* <Link href="/champions" className="block" aria-label="Cruip"> */}
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0 whitespace-nowrap" href="/champions">Découvrir <br/> Hugo Barbotin</a>
                {/* </Link> */}
              </div>
